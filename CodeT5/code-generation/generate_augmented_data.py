...
def main():
    ...
    # output_source_path = os.path.join(args.output_dir, "train.java-cs.txt.{}".format(args.sub_task.split("-")[0].strip()))
    # output_target_path = os.path.join(args.output_dir, "train.java-cs.txt.{}".format(args.sub_task.split("-")[1].strip()))
    # with open(output_source_path, "w") as f1, open(output_target_path, "w") as f2:
    #     for line1, line2 in pseudo_data:
    #         f1.write(line1)
    #         f1.write("\n")
    #         f2.write(line2)
    #         f2.write("\n")
